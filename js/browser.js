  ...
  return (
        ...
        !(function () {
          ...
          (function () {
            ...
            for (let e = 0; e < X.length; e++)
              (X[e].y =
                b[D.length + e] + 45 * Math.sin((e * M * Math.PI) / 180)),
                (X[e].x =
                  R[D.length + e] + 45 * Math.cos((e * M * Math.PI) / 180)),
            ...
            for (let e = 0; e < H.length; e++)
              (H[e].y =
                b[D.length + v + I.length + e] + 0 + e * B * Math.sin(s)),
                (H[e].x =
                  R[D.length + v + I.length + e] + 0 + e * B * Math.cos(s)),
                (i.fillStyle = H[e].color),
                i.fillText(H[e].value, H[e].x, H[e].y);
            for (let e = 0; e < W.length; e++)
              (W[e].y =
                b[D.length + v + I.length + H.length + e] +
                0 +
                e * B * Math.sin(n)),
                (W[e].x =
                  R[D.length + v + I.length + H.length + e] +
                  0 +
                  e * B * Math.cos(n)),
        ...
        e.timeStamp - l < 16 ||
          window.requestAnimationFrame(() => {
            ...
            Math.hypot(h.x - c.x, h.y - c.y) > 1 &&
              (w(h.x, h.y, d[Math.floor(Math.random() * t.length)]),
              (c.x = h.x),
              (c.y = h.y),
              (l = e.timeStamp));
          });
    ...
    (e.fairyDustCursor = function (e) {
      ...
      function g(e) {
        (o = window.innerWidth),
          (s = window.innerHeight),
          i
            ? ((d.width = n.clientWidth), (d.height = n.clientHeight))
      ...
      function p(e) {
        window.requestAnimationFrame(() => {
          ...
          Math.hypot(h.x - c.x, h.y - c.y) > 1.5 &&
            (y(h.x, h.y, r[Math.floor(Math.random() * t.length)]),
            (c.x = h.x),
            (c.y = h.y));
        });
      }
    ...
    (e.rainbowCursor = function (e) {
      ...
      function p(e) {
        ...
        if (!1 === u) {
          u = !0;
          for (let e = 0; e < d; e++) (t = l.x), (i = l.y), r.push(new v(t, i));
        }
        var t, i;
      }
      function y() {
    ...
    (e.textFlag = function (e) {
      ...
      for (let e = 0; e < c.length; e++)
        m[e] = { letter: c.charAt(e), x: g / 2, y: g / 2 };
    ...
    (e.trailingCursor = function (e) {
      ...
      function y(e) {
        ...
        if (!1 === u) {
          u = !0;
          for (let e = 0; e < d; e++)
            (t = l.x), (i = l.y), (n = m), r.push(new x(t, i, n));
        }
        var t, i, n;
      }
      function w() {
